...
<div class="navbar" id="navbarid">
    ...
    <a class="<?php echo $active3?>"  href="find_freelancer.php"><i class="fa fa-group"></i> Find Freelancers</a>
    <a class="<?php echo $active4?>" href="login.php" id="login"><i class="fa fa-fw fa-user "></i> Login</a>
